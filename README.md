# Microsoft Graph Explorer V4 + God Mode
...
[![Deploy to GitHub Pages](https://github.com/orgitcog/graph-explorer/actions/workflows/deploy.yml/badge.svg)](https://github.com/orgitcog/graph-explorer/actions/workflows/deploy.yml)
...
**This fork includes God Mode** - a rapid bulk provisioning system for Azure AD and GitHub Enterprise.
...
# Rapid provisioning - create 9 orgs with 50 users each (450 users in ~60s)
python god-mode/scripts/rapid_provision.py --orgs 9 --users 50

# Or use PowerShell
Import-Module ./god-mode/powershell/GodMode.psm1
New-GodModeInfrastructure -Organizations 9 -UsersPerOrg 50
```

See [god-mode/README.md](god-mode/README.md) for full documentation.
